/*
Lepore factorization nr. 138132537  simple  is free software
Lepore factorization nr. 138132537 simple is Alberico Lepore creation
this file is free software
The Lepore factorization nr. 138132537 simple is free software; you can redistribute it and/or modify
...
;
 ...
 mpz_set(a,due);
 while((mpz_cmp(p,uno)==0  ||  mpz_cmp(p,M)==0 || mpz_cmp(mom3,zero)!=0)  &&  mpz_cmp(a,max_a)<=0){
